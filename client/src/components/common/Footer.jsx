  ...
  return (
    <footer className="bg-navy text-white/80 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          <div className="flex items-center gap-2.5 mb-3">
            ...
            />
            <span className="font-serif-display text-lg font-bold text-gold-light">
              SCEC Allahabad
            </span>
          </div>
          <p className="text-sm leading-relaxed text-white/60">
            {settings?.siteName || 'SCEC Allahabad'} — A unit of Prayagraj
            Educom Pvt. Ltd. Established{' '}
            {settings?.established || '2009'}.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/courses" className="hover:text-gold-light transition-colors">Courses</Link></li>
            <li><Link to="/universities" className="hover:text-gold-light transition-colors">Universities</Link></li>
            <li><Link to="/gallery" className="hover:text-gold-light transition-colors">Gallery</Link></li>
            <li><Link to="/verification" className="hover:text-gold-light transition-colors">Certificate Verification</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/70">
            ...
            <li>Medical (GNM, ANM, D.Pharma)</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/70">
            <li className="flex items-start gap-2">
              ...
              {settings?.address || 'Prayagraj, Uttar Pradesh, India'}
            </li>
            {settings?.phone && (
      ...
      <div className="border-t border-white/10 py-4 text-center text-xs text-white/50">
        ...
        {' · '}
        <Link to="/admin/login" className="hover:text-white/30 transition-colors">
          Admin
        </Link>
      </div>
    </footer>
