...
import {
  LayoutDashboard, Bell, Image, BookOpen, Building2,
  GalleryHorizontalEnd, Mail, Users, Settings, MapPin, LogOut,
} from 'lucide-react';
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-[220px] bg-navy text-white flex flex-col h-screen sticky top-0 flex-shrink-0">
      ...
      {/* ── Logo header ── */}
      <div className="px-4 pt-5 pb-3 border-b border-white/10 flex items-center gap-2.5">
        <img
          src="/logo.png"
          alt="SCEC"
        ...
        />
        <div>
          <h2 className="text-[14px] font-bold text-gold-light leading-tight">
            SCEC Admin
          </h2>
