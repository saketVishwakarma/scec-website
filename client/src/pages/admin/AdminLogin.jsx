    ...
    <div className="min-h-screen bg-gradient-to-br from-navy via-navy-light to-navy-lighter flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-8">
        <div className="flex items-center justify-center gap-2 mb-1">
          ...
          <span className="font-serif-display text-xl font-bold text-navy">SCEC Admin</span>
        </div>
        <p className="text-center text-xs text-gray-400 mb-6">Sign in to manage the website</p>
